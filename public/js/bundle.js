      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(quantity, "/").concat(date));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/updateMyFavoriteTours/".concat(tourName)
            });
...
var aletrMessage = document.querySelector('body').dataset.alert;
if (aletrMessage) (0, _alerts.showAlert)('success', aletrMessage, 8);
