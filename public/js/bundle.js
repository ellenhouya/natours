...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWxsZW53MSIsImEiOiJja2owYnR0bWwxbzg3MnlwMmoyaWgzZms5In0.UVY0SAB1wIrnik2v88RxXQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'Please check your email to reset password');
            _context.next = 11;
            break;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3001/api/v1/users/resetPassword/".concat(token),
              data: {
                password: password,
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0.response);
            (0, _alerts.showAlert)('error', 'Failed to reset password. Please try again');
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, quantity, date) {
    var stripe, session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IwTLuAN569NyJV7kFuQqUkN7BszjMa9yhc9NzoYRMBl9XN9KkWaGOp5rG9vkXYUMmhEJWZI2Zuh3AP8ORjcce3y00DugW4WvO');
            _context.next = 4;
            return (0, _axios.default)("http://localhost:3001/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(quantity, "/").concat(date));
...
exports.deleteTour = exports.updateTour = exports.addTour = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'The tour has been created');
            location.reload();
            _context.next = 12;
            break;
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0.response);
            (0, _alerts.showAlert)('error', 'Unable to create the tour. Please fill out all required fields.');
...
var updateTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tourId, form) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3001/api/v1/tours/".concat(tourId),
              data: form
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'data deleted successfully');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manageUsers.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://localhost:3001/api/v1/users/".concat(userId)
            });

          case 3:
            res = _context.sent;
            if (res.status === 204) (0, _alerts.showAlert)('success', 'The user has been deleted');
            location.reload();
            _context.next = 12;
            break;
...
var updateUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(userId, data) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'The user data has been updated');
            _context2.next = 11;
            break;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://localhost:3001/api/v1/tours/".concat(tourId, "/reviews"),
              data: {
                rating: rating,
                review: review,
                tour: tourId
...
var updateReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(reviewId, rating, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3001/api/v1/reviews/".concat(reviewId),
              data: {
                rating: rating,
                review: review
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review was updated');
            }
  ...
  return function updateReview(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateReview = updateReview;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manageFavoriteTours.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeTourFromFavoriteList = exports.manageFavoriteTours = void 0;
...
var manageFavoriteTours = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourName) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3001/api/v1/users/updateMyFavoriteTours/".concat(tourName)
            });
  ...
  return function manageFavoriteTours(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.manageFavoriteTours = manageFavoriteTours;

var removeTourFromFavoriteList = /*#__PURE__*/function () {
  ...
  return function removeTourFromFavoriteList(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.removeTourFromFavoriteList = removeTourFromFavoriteList;
...
exports.removeBooking = exports.updateBooking = void 0;
...
var updateBooking = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(bookingId, data) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3001/api/v1/bookings/".concat(bookingId),
              data: data
            });

          case 3:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'The review has been updated');
            _context.next = 11;
            break;
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0.response);
            (0, _alerts.showAlert)('error', 'Unable to update the review. Please try again.');
  ...
  return function updateBooking(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var removeBooking = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(bookingId, data) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'The review has been removed');
            _context2.next = 11;
            break;
          ...
          case 7:
            ...
            _context2.t0 = _context2["catch"](0);
            console.log(_context2.t0.response);
            (0, _alerts.showAlert)('error', 'Unable to remove the review. Please try again.');
  ...
  return function removeBooking(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var _manageFavoriteTours = require("./manageFavoriteTours");
...
var toursUpdateForm = document.querySelectorAll('.tours-form');
var deleteTourBtns = document.querySelectorAll('.delete-tour-button');
var forgotPasswordForm = document.querySelector('.form--forgotPassword');
var passwordResetForm = document.querySelector('.form--passwordReset');
var addTourForm = document.querySelector('.tours-form-add');
var submitReviewBtn = document.querySelector('.submit-review-btn');
var allStars = document.querySelectorAll('.fa-star');
var allThumbsUp = document.querySelectorAll('.thumbs-up-icon');
var allTrashIcons = document.querySelectorAll('.fa-trash-alt');
var reviewsCon = document.querySelector('.all-reviews-con');
var allReviewUpdateIcons = document.querySelectorAll('.check-square-review');
var removeIcons = document.querySelectorAll('.remove-icon');
var allUsersCon = document.querySelector('.all-users-con');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    var quantity = document.querySelector('.tour-quantity').value;
    var selectEle = document.getElementById('selectDate');
    var date = selectEle.options[selectEle.selectedIndex].value;
    if (quantity <= 0) return (0, _alerts.showAlert)('error', 'Quantity must be above 1');
    e.target.textContent = 'Processing...';
    var tourId = e.target.dataset.tourId;
    (0, _stripe.bookTour)(tourId, quantity, date);
  });
}

if (toursUpdateForm) {
  toursUpdateForm.forEach(function (tourForm) {
    tourForm.addEventListener('submit', /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
        var uploadCon, cardDetails, imageCoverFile, image1, image2, image3, name, difficulty, duration, summary, description, startDate, maxGroupSize, price, form, tourId;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                uploadCon = e.target.firstElementChild.children[4].firstElementChild.firstElementChild;
                cardDetails = e.target.firstElementChild.children[5];
                imageCoverFile = document.getElementById("".concat(uploadCon.children[1].getAttribute('id'))).files[0];
                image1 = document.querySelector(".".concat(uploadCon.children[3].getAttribute('class'))).files[0];
                image2 = document.querySelector(".".concat(uploadCon.children[5].getAttribute('class'))).files[0];
                image3 = document.querySelector(".".concat(uploadCon.children[7].getAttribute('class'))).files[0];
                name = document.getElementById("".concat(e.target.firstElementChild.children[4].children[1].firstElementChild.getAttribute('id')));
                difficulty = document.getElementById("".concat(cardDetails.firstElementChild.firstElementChild.getAttribute('id')));
                duration = document.getElementById("".concat(cardDetails.firstElementChild.children[1].getAttribute('id')));
                summary = document.getElementById("".concat(cardDetails.children[2].getAttribute('id')));
                description = document.getElementById("".concat(cardDetails.children[4].children[1].getAttribute('id')));
                startDate = document.getElementById("".concat(cardDetails.children[6].children[1].getAttribute('id')));
                maxGroupSize = document.getElementById("".concat(cardDetails.children[10].children[1].getAttribute('id')));
                price = document.getElementById("".concat(e.target.firstElementChild.children[6].firstElementChild.firstElementChild.firstElementChild.getAttribute('id')));
                form = new FormData();
                ...
                if (description.value) form.append('startLocation.description', description.value);
                ...
                tourId = e.target.getAttribute('id');
                (0, _manageTours.updateTour)(tourId, form);
  ...
  deleteTourBtns.forEach(function (deletBtn) {
    deletBtn.addEventListener('click', function (e) {
      var tourId = e.target.parentElement.parentElement.parentElement.parentElement.getAttribute('id');
      var isConfirmed = confirm('Are you sure you want to delete the tour?');
      if (isConfirmed) (0, _manageTours.deleteTour)(tourId);
    });
  });
}

document.querySelectorAll('.upload-con').forEach(function (uploadCon) {
  uploadCon.addEventListener('change', function (e) {
    e.preventDefault();
    e.target.previousElementSibling.style.cssText = 'background: rgba(29, 53, 87, 0.5) ; color:#fff';
...
if (passwordResetForm) {
  passwordResetForm.addEventListener('submit', function (e) {
    ...
    var token = location.pathname.split('/')[5];
    (0, _resetPassword.resetPassword)(password, passwordConfirm, token);
  });
}

if (addTourForm) {
  addTourForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var name, imageCover, image1, image2, image3, duration, difficulty, summary, description, startDates, startDatesArr, maxGroupSize, price, guides, guidesIds, form, locations, startLocation;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              name = document.querySelector('.tour-name-add').value;
              imageCover = document.getElementById('tourImageCover-add').files[0];
              image1 = document.getElementById('tourImages--add1').files[0];
              image2 = document.getElementById('tourImages--add2').files[0];
              image3 = document.getElementById('tourImages--add3').files[0];
              duration = document.getElementById('duration-add').value;
              difficulty = document.getElementById('difficulty-add').value;
              summary = document.getElementById('summary-add').value;
              description = document.getElementById('description-add').value;
              startDates = document.getElementById('startDate-add').value;
              startDatesArr = startDates.split(',').map(function (date) {
                return date.trim() + 'T09:00:00.000Z';
              });
              maxGroupSize = document.getElementById('maxGroupSize-add').value;
              price = document.getElementById('price-add').value;
              guides = document.getElementById('guides-add').value;
              guidesIds = guides.split(',').map(function (id) {
                return id.trim();
              });
              form = new FormData();
              ...
              guidesIds.forEach(function (id) {
                form.append('guides[]', id);
              });
              startDatesArr.forEach(function (date) {
...
function createFormData(form, key, data) {
  if (_typeof(data) === 'object') {
    for (var prop in data) {
      createFormData(form, "".concat(key, "[").concat(prop, "]"), data[prop]);
    }
  } else {
...
if (submitReviewBtn || allReviewUpdateIcons) {
  ...
  allStars.forEach(function (star) {
    star.addEventListener('click', function (e) {
      var starId = e.target.dataset.starId * 1;

      for (var i = starId % 5 === 0 ? starId - 4 : Math.floor(starId / 5) * 5 + 1; i <= starId; i++) {
        document.querySelector(".star-".concat(i)).style.color = '#ffc300';

        for (var j = starId + 1; j <= Math.floor(starId / 5 + 1) * 5; j++) {
          var jEle = document.querySelector(".star-".concat(j));
      ...
      var offset = Math.floor(starId % 5) === 0 ? (starId / 5 - 1) * 5 : Math.floor(starId / 5) * 5;
  ...
  if (submitReviewBtn) {
    submitReviewBtn.addEventListener('click', function (e) {
      var review = document.querySelector('.review-detail').value;
      var tourId = location.pathname.split('/')[2];
      (0, _submitReview.submitReview)(rating, review, tourId);
    });
  }

  if (allReviewUpdateIcons) {
    allReviewUpdateIcons.forEach(function (updateIcon) {
      updateIcon.addEventListener('click', /*#__PURE__*/function () {
          ...
          return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  review = e.target.nextElementSibling.nextElementSibling.children[1].value;
                  reviewId = e.target.dataset.updateReviewId;
                  _context5.next = 4;
                  return (0, _updateReview.updateReview)(reviewId, rating, review);
...
if (allThumbsUp) {
  allThumbsUp.forEach(function (thumbsUp) {
    thumbsUp.addEventListener('click', function (e) {
      var tourName = thumbsUp.dataset.tourName;
      (0, _manageFavoriteTours.manageFavoriteTours)(tourName);
    });
  });
}

if (reviewsCon) {
  allTrashIcons.forEach(function (trashIcon) {
    trashIcon.addEventListener('click', function (e) {
      var reviewId = e.target.dataset.reviewId;
      var isConfirmed = confirm('Are you sure you want to delete the review?');

      if (isConfirmed) {
        (0, _manageFavoriteTours.removeTourFromFavoriteList)(reviewId);
      }
    });
  });
}
...
if (allUsersCon) {
  removeIcons.forEach(function (icon) {
    icon.addEventListener('click', function (e) {
      var userId = e.target.parentElement.previousElementSibling.children[0].textContent.replace('ID: ', '');
      var isConfirmed = confirm('Are you sure you want to delete the user?');
      if (isConfirmed) (0, _manageUsers.deleteUser)(userId);
    });
  });
}

var updateUserForm = document.querySelector('.img-box-update-form');

if (updateUserForm) {
  updateUserForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(e) {
      var userId, name, email, role, photo, form;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              name = document.querySelector('.name-update-field').value.trim();
              email = document.querySelector('.email-update-field').value.trim();
              role = document.querySelector('.role-update-field').value.trim();
              ...
              _context6.next = 13;
              return (0, _manageUsers.updateUser)(userId, form);
  ...
  document.querySelector('.img-box-update').addEventListener('change', function (e) {
    e.preventDefault();
    e.target.previousElementSibling.style.cssText = 'background: rgba(29, 53, 87, 0.5) ; color:#fff';
    e.target.previousElementSibling.textContent = e.srcElement.files[0].name;
  });
...
var updatebookingBtn = document.querySelector('.fa-edit-booking');
var updateBookingCon = document.querySelector('.update-booking-con');

if (updateBookingCon) {
  updatebookingBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e) {
      var getDefaultValue, bookingId, createAt, price, paid;
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              getDefaultValue = function _getDefaultValue(ele) {
                return ele.getAttribute('placeholder');
              };

              bookingId = location.pathname.split('/')[2];
              createAt = document.querySelector('.booking-input-createdAt');
              price = document.querySelector('.booking-input-price');
              paid = document.querySelector('.booking-input-paid');

              if (!(!createAt && !price && !paid)) {
                _context7.next = 7;
                break;
              }
            ...
            case 7:
              _context7.next = 9;
              return (0, _manageBookings.updateBooking)(bookingId, {
                createAt: createAt.value ? new Date(createAt.value) : getDefaultValue(createAt).slice(0, -2),
...
var removeBookingIcons = document.querySelectorAll('.remove-icon-booking');

if (removeBookingIcons) {
  removeBookingIcons.forEach(function (icon) {
    icon.addEventListener('click', /*#__PURE__*/function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(e) {
        var reviewId, isConfirmed;
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                reviewId = e.target.dataset.reviewId;
                isConfirmed = confirm('Are you sure you want to remove the booking?');
                ...
                _context8.next = 5;
                return (0, _manageBookings.removeBooking)(reviewId);
...
var sortEle = document.getElementById('sort-by');
var filterEle = document.getElementById('filter-by');

if (sortEle) {
  sortEle.addEventListener('change', function (e) {
    var sortValue = e.target.value;
    var filterKey = filterEle.options[filterEle.selectedIndex].value;
    var inputValue = document.querySelector('.filter-input').value;

    if (location.pathname === '/manage-users') {
      if (inputValue) return assignLocation_filter('users', filterKey, inputValue, sortValue);
      return assignLocation_sort('users', sortValue);
    }

    if (location.pathname === '/manage-reviews') {
      if (inputValue) return assignLocation_filter('reviews', filterKey, inputValue, sortValue);
      return assignLocation_sort('reviews', sortValue);
    }

    if (inputValue) {
      if (sortValue === 'top-5-cheap') return location.assign("".concat(sortValue, "?sort=").concat(sortValue, "&").concat(filterKey, "=").concat(inputValue));
      return location.assign("/?sort=".concat(sortValue, "&").concat(filterKey, "=").concat(inputValue.split(' ').join('-')));
    } else {
      if (sortValue === 'top-5-cheap') return location.assign(sortValue);
      location.assign("/".concat(sortValue === 'default' ? '' : "?sort=".concat(sortValue)));
    }
  });
}
